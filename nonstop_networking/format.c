...
const char *err_bad_file_size =
    "Bad file size\n"; // Error message to send if the client sends too little
                       // or too much data
const char *err_no_such_file =
    "No such file\n"; // Error message if a client tries to GET or DELETE a non
                      // existent file
